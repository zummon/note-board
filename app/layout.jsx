			...
			<body className="">
				...
				<div className="flex flex-col items-center min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-400 dark:text-gray-500 font-medium duration-500">
					<div className="flex flex-wrap ml-auto p-4">
						{path ? (
							<Link className="flex items-center cursor-pointer bg-white dark:bg-gray-800 shadow hover:shadow-lg focus:shadow-lg py-1 px-3 rounded-3xl transition-responsive duration-500 ease-in-out mr-4" href={`/${lang}?dark=${dark}`}>
						...
						<label className="flex items-center cursor-pointer bg-white dark:bg-gray-800 shadow hover:shadow-lg focus:shadow-lg py-1 px-3 rounded-3xl transition-responsive duration-500 ease-in-out mr-4 focus-within:shadow-lg">
							{/* heroicons Solid moon */}
							<svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
								<path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
							</svg>
							<input className="sr-only" type="checkbox" checked={dark} onChange={(e) => {
								router.replace(`${pathname}?dark=${e.target.checked}`)
							}} />
						</label>
						<label className="flex items-center cursor-pointer bg-white dark:bg-gray-800 shadow hover:shadow-lg focus:shadow-lg py-1 px-3 rounded-3xl transition-responsive duration-500 ease-in-out focus-within:shadow-lg">
