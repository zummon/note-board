...
document.addEventListener("DOMContentLoaded", function () {
			...
			content: [
				{
					title: "色刈来月",
					desc:
						"色刈来月郷連新将用聴作査刊城農東題提温。読並詳高省生将報万力強続強辞点。"
				},
				{
					title: "話浮紙",
				...
				},
				{
					title: "更伎宿聞権刊石",
					desc:
						"更伎宿聞権刊石禁字利追係見徴働文講。高糊試月社覧刊回行委持問話布泣。"
				},
				{
					title: "読一甘両合",
					desc:
						"読一甘両合道福全伝同一夢治。阻数鈴求数風円入口属国意。治骨込井辛品樽新入子加玲。更中切切手流福能金住表料敗見挑景来。"
				}
			],
			madeBy: "由 ZUMMON 制造"
		}
	...
	function handleLanguage(locale) {
		...
		document.querySelectorAll('[data-content="button"]').forEach(function (elem) {
